...
#             best_phrases = get_best_phrases(phrases, threshold)[:max_nodes]
...
#                                 if(len(common_phrases) == max_nodes):
#                                     break
#                     else:
#                         continue
#             else:
